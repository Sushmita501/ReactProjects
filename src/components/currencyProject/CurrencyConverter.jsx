...
// import {InputBox} from "./components/currencyProject/InputBox"
...
export default function CurrencyConverter(){
  ...
  const convert = () => {
   ...
   return (
      ...
      style={{
         backgroundImage: `url('https://img.freepik.com/free-vector/abstract-digital-low-poly-connection-banner-design_1017-32434.jpg')`,
      }}
      >
